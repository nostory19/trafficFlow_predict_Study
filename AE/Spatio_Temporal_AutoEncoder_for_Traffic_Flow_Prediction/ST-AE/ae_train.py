...
parser.add_argument('--save', type=str, default='E:/论文/交通流/AE/Spatio_Temporal_AutoEncoder_for_Traffic_Flow_Prediction/ST-AE/save_ae/PEMS08_stae_test_', help='save path')
