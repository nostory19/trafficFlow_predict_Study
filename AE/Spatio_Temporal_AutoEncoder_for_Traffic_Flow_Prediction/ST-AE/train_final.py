...
parser.add_argument('--model_path', type=str, default='E:/论文/交通流/AE/Spatio_Temporal_AutoEncoder_for_Traffic_Flow_Prediction/ST-AE/pretrained/PEMS08_stae.pth', help='path of pretrained model')
...
parser.add_argument('--save', type=str, default='E:/论文/交通流/AE/Spatio_Temporal_AutoEncoder_for_Traffic_Flow_Prediction/ST-AE/save/pems08/stae_12-12_', help='save path')
